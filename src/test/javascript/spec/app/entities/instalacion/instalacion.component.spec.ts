...
import { InstalacionComponent } from 'app/entities/instalacion/instalacion.component';
...
describe('Component Tests', () => {
  describe('Instalacion Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.instalacions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
